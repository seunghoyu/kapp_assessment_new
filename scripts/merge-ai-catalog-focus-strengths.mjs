...
const FOCUS = {
  chatgpt_team:
    "범용 대화·글·이미지·코드 생성에 강하고, 플러그인·GPTs 등 생태계가 넓음.",
  copilot_github:
    "IDE 안에서 코드 자동완성·리팩터링에 특화(저장소 맥락 반영).",
  cursor:
    "에디터 자체가 AI 중심(채팅·편집·코드베이스 검색)으로 개발 워크플로에 특화.",
  perplexity:
    "웹 검색·출처 링크를 곁들인 답변(리서치·팩트 확인)에 강함.",
  notion_ai:
    "노트·DB·문서 안에서 요약·초안·정리(워크스페이스 맥락)에 특화.",
  gamma:
    "프롬프트로 슬라이드·발표 자료 초안을 빠르게 만드는 데 특화.",
  meta_advantage:
  ...
  samsung_gauss:
    "갤럭시·기업 솔루션에 탑재되는 삼성 생성형(온디바이스·B2B)에 특화.",
  microsoft_copilot:
